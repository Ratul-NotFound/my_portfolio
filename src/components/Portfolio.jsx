...
import { 
  ...
  Sparkles, Zap, Brain, Server, Globe, ArrowRight, MapPin, CheckCircle, 
  Star, Cpu, Binary, Network, Award, TrendingUp, Coffee, Rocket, 
  Circle, Play, Pause, Volume2, VolumeX, Command, ChevronRight, Home,
  User, Briefcase, Wrench
} from 'lucide-react';
...
const Portfolio = () => {
  ...
  const stats = [
    { value: "3+", label: "Years", desc: "Experience", icon: TrendingUp, color: "cyan" },
    { value: "15+", label: "Projects", desc: "Deployed", icon: Rocket, color: "purple" },
    { value: "10K+", label: "Users", desc: "Active", icon: Star, color: "pink" },
    { value: "2K+", label: "Commits", desc: "GitHub", icon: Code2, color: "cyan" }
  ];

  const techStack = {
    frontend: [
      { name: "Next.js", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nextjs/nextjs-original.svg", color: "hover:border-white" },
      { name: "React", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg", color: "hover:border-cyan-400" },
      { name: "TypeScript", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/typescript/typescript-original.svg", color: "hover:border-blue-400" },
      { name: "Tailwind CSS", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tailwindcss/tailwindcss-plain.svg", color: "hover:border-cyan-400" },
      { name: "JavaScript", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg", color: "hover:border-yellow-400" }
    ],
    backend: [
      { name: "Node.js", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original.svg", color: "hover:border-green-400" },
      { name: "Express", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/express/express-original.svg", color: "hover:border-slate-300" },
      { name: "PostgreSQL", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original.svg", color: "hover:border-blue-400" },
      { name: "MongoDB", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mongodb/mongodb-original.svg", color: "hover:border-green-400" },
      { name: "Redis", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/redis/redis-original.svg", color: "hover:border-red-400" },
      { name: "Firebase", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/firebase/firebase-plain.svg", color: "hover:border-orange-400" }
    ],
    ai: [
      { name: "Python", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg", color: "hover:border-blue-400" },
      { name: "TensorFlow", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tensorflow/tensorflow-original.svg", color: "hover:border-orange-400" },
      { name: "PyTorch", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/pytorch/pytorch-original.svg", color: "hover:border-red-400" },
      { name: "OpenAI", icon: "https://upload.wikimedia.org/wikipedia/commons/4/4d/OpenAI_Logo.svg", color: "hover:border-emerald-400" },
      { name: "Pandas", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/pandas/pandas-original.svg", color: "hover:border-purple-400" }
    ],
    infra: [
      { name: "Docker", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/docker/docker-original.svg", color: "hover:border-blue-400" },
      { name: "Kubernetes", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/kubernetes/kubernetes-plain.svg", color: "hover:border-blue-400" },
      { name: "AWS", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/amazonwebservices/amazonwebservices-original-wordmark.svg", color: "hover:border-orange-400" },
      { name: "Git", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg", color: "hover:border-orange-400" },
      { name: "GitHub", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg", color: "hover:border-white" },
      { name: "Linux", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linux/linux-original.svg", color: "hover:border-yellow-400" }
    ]
  };
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-1/3 right-1/4 w-64 h-64 bg-pink-500/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s', animationDuration: '5s' }}></div>
        <div className="absolute bottom-1/3 left-1/4 w-80 h-80 bg-blue-500/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1.5s', animationDuration: '6s' }}></div>
      ...
      <main className="relative z-10">
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="space-y-8 animate-slide-up">
                ...
                <div className="flex items-center gap-4 pt-4">
                  {[
                    { icon: Github, href: "https://github.com/ratul-notfound", label: "GitHub", color: "hover:bg-slate-800" },
                    { icon: Linkedin, href: "https://linkedin.com/in/mahmud-hasan-ratul", label: "LinkedIn", color: "hover:bg-blue-600/20" },
                    { icon: Mail, href: "mailto:m.h.ratul18@gmail.com", label: "Email", color: "hover:bg-cyan-600/20" }
                  ].map(social => (
                    <a
                      key={social.label}
                      href={social.href}
                      ...
                      className={`group p-4 bg-slate-800/30 backdrop-blur-xl border border-slate-700 hover:border-cyan-500 rounded-xl transition-all hover:scale-110 ${social.color}`}
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mt-20">
              {stats.map((stat, i) => (
                ...
                >
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-br from-${stat.color}-500/0 to-${stat.color}-500/0 group-hover:from-${stat.color}-500/10 group-hover:to-transparent transition-all duration-500`}></div>
                  
                  <div className="relative z-10">
                    <stat.icon className={`w-8 h-8 md:w-10 md:h-10 text-${stat.color}-400 mb-4 group-hover:scale-110 transition-transform`} />
                  ...
                  {/* Corner accent */}
                  <div className={`absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-${stat.color}-500/20 to-transparent rounded-bl-full opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 md:gap-8">
              {[
                ...
                >
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-br from-${item.color}-500/0 to-${item.color}-500/0 group-hover:from-${item.color}-500/10 group-hover:to-transparent transition-all duration-500`}></div>
                  
                  <div className="relative z-10">
                    <div className={`w-16 h-16 bg-gradient-to-br from-${item.color}-500/20 to-${item.color}-600/10 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}>
                  ...
                  {/* Corner decoration */}
                  <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-gradient-to-br from-cyan-500/10 to-transparent rounded-full blur-2xl group-hover:scale-150 transition-transform duration-700"></div>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* Projects Section - Magazine Style with Images */}
        <section id="projects" className="py-20 md:py-32 px-4 relative">
          ...
          <div className="absolute bottom-1/4 right-0 w-64 h-64 bg-cyan-500/5 rounded-full blur-3xl -z-10"></div>
        </section>

        {/* Skills Section - Trendy with Real Logos */}
        <section id="skills" className="py-20 md:py-32 px-4 relative">
            ...
            <div className="space-y-8">
              {Object.entries(techStack).map(([category, skills]) => (
                (activeTech === 'all' || activeTech === category) && (
                  ...
                  >
                    {/* Category Header - Glassmorphism Card */}
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                      {skills.map((skill, i) => (
                        <div
                          key={i}
                          className={`group/card relative p-6 bg-slate-900/50 backdrop-blur-xl border border-slate-800 ${skill.color} rounded-2xl transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/10 cursor-default overflow-hidden`}
                          style={{ 
                          ...
                          <div className="relative z-10 flex flex-col items-center gap-4">
                            ...
                            <div className="relative w-16 h-16 flex items-center justify-center">
                              ...
                              <div className="relative w-full h-full p-2 bg-slate-800/50 rounded-xl border border-slate-700 group-hover/card:border-slate-600 transition-all group-hover/card:scale-110">
                                ...
                                />
                                {/* Fallback */}
                                <div className="hidden absolute inset-0 items-center justify-center text-2xl font-bold text-cyan-400">
                                  {skill.name.charAt(0)}
                                </div>
                              </div>
          ...
          <div className="absolute top-1/2 right-0 w-64 h-64 bg-purple-500/5 rounded-full blur-3xl -z-10"></div>
        </section>
